...
# Ship the packaged default ruleset so the sidecar can load ignore globs / thresholds even when
# running from a PyInstaller extraction directory.
datas += [('ruleset.default.yaml', '.')]
