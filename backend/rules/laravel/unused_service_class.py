...
class UnusedServiceClassRule(Rule):
    ...
    severity_weight = 0
    confidence = 'low'
    fix_suggestion = 'Address the unused service class by making the framework contract explicit and keeping the change local to the affected boundary.'
    examples = {}
    priority = 4
    group = 'Dead Code'
    applies_to = ['service']
    ...
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'quality', 'concern': 'unused-service-class'}
