...
class IocInsteadOfNewRule(Rule):
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Move the prefer ioc over new responsibility into the appropriate service, action, repository, or boundary object. Keep controllers and UI components focused on orchestration only.'
    examples = {}
    priority = 3
    ...
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'architecture', 'concern': 'ioc-instead-of'}
    """
