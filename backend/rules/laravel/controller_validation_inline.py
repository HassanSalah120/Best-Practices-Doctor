...
class ControllerInlineValidationRule(Rule):
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Address the inline validation in controller by making the framework contract explicit and keeping the change local to the affected boundary.'
    examples = {}
    priority = 3
    group = 'Code Quality'
    ...
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'quality', 'concern': 'controller-inline-validation'}
    """
