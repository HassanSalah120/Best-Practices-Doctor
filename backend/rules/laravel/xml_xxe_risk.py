...
class XmlXxeRiskRule(Rule):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Remove the potential xml external entity risk risk and enforce the relevant Laravel/React security control at the boundary. Add a regression test that proves unsafe input or configuration is rejected.'
    examples = {}
    priority = 1
    ...
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'security', 'concern': 'xml-xxe'}
