...
class ActionClassSuggestionRule(Rule):
    ...
    severity_weight = 0
    confidence = 'low'
    fix_suggestion = 'Move the action class suggestion responsibility into the appropriate service, action, repository, or boundary object. Keep controllers and UI components focused on orchestration only.'
    examples = {}
    priority = 4
    ...
    analysis_cost = 'high'
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'architecture', 'concern': 'action-class-suggestion'}
