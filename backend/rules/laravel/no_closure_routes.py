...
class NoClosureRoutesRule(Rule):
    ...
    severity_weight = 0
    confidence = 'high'
    fix_suggestion = 'Move the avoid closure routes responsibility into the appropriate service, action, repository, or boundary object. Keep controllers and UI components focused on orchestration only.'
    examples = {}
    priority = 3
    ...
    analysis_cost = 'low'
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'architecture', 'concern': 'closure-routes'}
