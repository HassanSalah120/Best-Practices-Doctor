...
class MassiveModelRule(Rule):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Address the massive model detection by making the framework contract explicit and keeping the change local to the affected boundary.'
    examples = {}
    priority = 3
    group = 'Data Access'
    applies_to = ['model']
    ...
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'quality', 'concern': 'massive-model'}
