...
class EnumSuggestionRule(Rule):
    severity_weight = 0
    confidence = 'low'
    fix_suggestion = 'Address the enum suggestion by making the framework contract explicit and keeping the change local to the affected boundary.'
    examples = {}
    priority = 4
    group = 'Code Quality'
    applies_to = ['global']
    ...
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'quality', 'concern': 'enum-suggestion'}
    """
