...
class FatControllerRule(Rule):
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Move the fat controller detection responsibility into the appropriate service, action, repository, or boundary object. Keep controllers and UI components focused on orchestration only.'
    examples = {}
    priority = 2
