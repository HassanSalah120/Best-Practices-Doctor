...
class ActionClassNamingConsistencyRule(Rule):
    ...
    severity_weight = 0
    confidence = 'low'
    fix_suggestion = 'Move the action class naming consistency responsibility into the appropriate service, action, repository, or boundary object. Keep controllers and UI components focused on orchestration only.'
    examples = {}
    priority = 4
    ...
    auto_fixable = False
    tags = {'domain': 'laravel', 'type': 'architecture', 'concern': 'action-class-naming'}
