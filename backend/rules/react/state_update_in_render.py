...
class StateUpdateInRenderRule(Rule):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Refactor the component code to remove the state update during render pattern while preserving the public UI behavior. Prefer explicit state, props, and lifecycle boundaries over implicit side effects.'
    examples = {}
    priority = 2
    ...
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'quality', 'concern': 'state-update-in'}
