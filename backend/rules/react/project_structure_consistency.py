...
class ReactProjectStructureConsistencyRule(Rule):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Move the react project structure consistency responsibility into the appropriate service, action, repository, or boundary object. Keep controllers and UI components focused on orchestration only.'
    examples = {}
    priority = 3
    ...
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'architecture', 'concern': 'react-project-structure'}
