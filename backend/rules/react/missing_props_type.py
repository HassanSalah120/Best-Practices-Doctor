...
class MissingPropsTypeRule(Rule):
    ...
    severity_weight = 0
    confidence = 'low'
    fix_suggestion = 'Refactor the component code to remove the missing props type pattern while preserving the public UI behavior. Prefer explicit state, props, and lifecycle boundaries over implicit side effects.'
    examples = {}
    priority = 4
    ...
    analysis_cost = 'low'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'quality', 'concern': 'props-type'}
