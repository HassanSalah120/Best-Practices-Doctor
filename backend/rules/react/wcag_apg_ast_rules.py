...
class SemanticWrapperBreakageRule(_WcagAstRuleBase):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the semantic wrapper breakage is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    ...
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'semantic-wrapper-breakage'}
...
class InteractiveAccessibleNameRequiredRule(_WcagAstRuleBase):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the interactive accessible name required is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    group = 'React Accessibility'
    applies_to = ['react-component']
    ...
    analysis_cost = 'medium'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'interactive-accessible-name'}
...
class JsxAriaAttributeFormatRule(_WcagAstRuleBase):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the jsx aria attribute format is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    group = 'React Accessibility'
    ...
    analysis_cost = 'medium'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'jsx-aria-attribute'}
...
class OutsideClickWithoutKeyboardFallbackRule(_WcagAstRuleBase):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the outside click without keyboard fallback is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    group = 'React Accessibility'
    applies_to = ['react-component']
    ...
    analysis_cost = 'medium'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'outside-click-keyboard'}
...
class APGTabsKeyboardContractRule(_WcagAstRuleBase):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the apg tabs keyboard contract is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    group = 'React Accessibility'
    applies_to = ['react-component']
    ...
    analysis_cost = 'medium'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'apg-tabs-keyboard'}
...
class APGAccordionDisclosureContractRule(_WcagAstRuleBase):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the apg accordion/disclosure contract is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    group = 'React Accessibility'
    applies_to = ['react-component']
    ...
    analysis_cost = 'medium'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'apg-accordion-disclosure'}
...
class APGMenuButtonContractRule(_WcagAstRuleBase):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the apg menu button contract is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    group = 'React Accessibility'
    applies_to = ['react-component']
    ...
    analysis_cost = 'medium'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'apg-menu-button'}
...
class APGComboboxContractRule(_WcagAstRuleBase):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the apg combobox contract is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    group = 'React Accessibility'
    applies_to = ['react-component']
    ...
    analysis_cost = 'medium'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'apg-combobox-contract'}
...
class DialogFocusRestoreMissingRule(_WcagAstRuleBase):
    ...
    _AUTO_RESTORE_LIBRARIES = (
        ...
        "@react-aria/overlays",
        # Case-insensitive common project components
        "ui/modal",
        "ui/dialog",
        "ui/drawer",
        "ui/popover",
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Update the component markup and interaction contract so the dialog focus restore missing is accessible by keyboard and assistive technology. Verify the expected ARIA/semantic state in a component test when practical.'
    examples = {}
    priority = 3
    group = 'React Accessibility'
    applies_to = ['react-component']
    ...
    analysis_cost = 'medium'
    auto_fixable = False
    tags = {'domain': 'react', 'type': 'accessibility', 'concern': 'dialog-focus-restore'}
