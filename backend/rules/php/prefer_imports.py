...
class PreferImportsRule(Rule):
    ...
    severity_weight = 0
    confidence = 'low'
    fix_suggestion = 'Refactor the PHP code to remove the prefer imports instead of fully-qualified class names pattern and keep the responsibility explicit. Add a small regression test for the affected class or function when behavior changes.'
    examples = {}
    priority = 4
    group = 'PHP Quality'
    ...
    auto_fixable = False
    tags = {'domain': 'php', 'type': 'quality', 'concern': 'prefer-imports'}
