...
class CircularDependencyRule(Rule):
    ...
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Move the circular dependency responsibility into the appropriate service, action, repository, or boundary object. Keep controllers and UI components focused on orchestration only.'
    examples = {}
    priority = 2
    ...
    analysis_cost = 'high'
    auto_fixable = False
    tags = {'domain': 'php', 'type': 'architecture', 'concern': 'circular-dependency'}
