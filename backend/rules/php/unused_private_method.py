...
class UnusedPrivateMethodRule(Rule):
    ...
    severity_weight = 0
    confidence = 'low'
    fix_suggestion = 'Refactor the PHP code to remove the unused private method pattern and keep the responsibility explicit. Add a small regression test for the affected class or function when behavior changes.'
    examples = {}
    priority = 4
    group = 'Dead Code'
    ...
    auto_fixable = False
    tags = {'domain': 'php', 'type': 'quality', 'concern': 'unused-private-method'}
