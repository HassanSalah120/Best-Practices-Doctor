...
class HighComplexityRule(Rule):
    severity_weight = 0
    confidence = 'medium'
    fix_suggestion = 'Refactor the PHP code to remove the high complexity detection pattern and keep the responsibility explicit. Add a small regression test for the affected class or function when behavior changes.'
    examples = {}
    priority = 3
    group = 'PHP Quality'
