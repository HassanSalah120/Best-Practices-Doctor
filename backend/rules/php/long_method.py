...
class LongMethodRule(Rule):
    severity_weight = 0
    confidence = 'low'
    fix_suggestion = 'Move the long method detection responsibility into the appropriate service, action, repository, or boundary object. Keep controllers and UI components focused on orchestration only.'
    examples = {}
    priority = 4
