...
def test_no_inline_types_skips_single_local_type_in_component():
    facts = Facts(project_path=".")
    facts.react_components.append(
        ReactComponentInfo(
            name="Settings",
            file_path="frontend/src/pages/Settings.tsx",
            file_hash="deadbeef",
            line_start=1,
            line_end=120,
            loc=120,
...
def test_no_inline_types_skips_context_contract_modules():
    facts = Facts(project_path=".")
    facts.react_components.append(
        ReactComponentInfo(
            name="AuthProvider",
            file_path="frontend/src/lib/AuthContext.tsx",
            file_hash="deadbeef",
            line_start=1,
            line_end=120,
            loc=120,
