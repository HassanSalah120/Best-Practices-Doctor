...
async def test_scan_pipeline_runs_stages_in_order():
    ...
    pipeline = ScanPipeline(
        ...
        contract_stage=_RecorderStage("contract_checks", order),
    ...
    assert order == ["detect_project", "build_facts", "run_rules", "contract_checks", "scoring", "reporting"]
...
async def test_scan_pipeline_stops_on_critical_error():
    ...
    pipeline = ScanPipeline(
        ...
        contract_stage=_RecorderStage("contract_checks", []),
