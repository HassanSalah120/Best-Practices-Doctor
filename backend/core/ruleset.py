    ...
    def default(cls) -> "Ruleset":
        ...
        return Ruleset(
            ...
            rules={
                ...
                "custom-exception-suggestion": RuleConfig(enabled=True, severity="low", category="laravel"),
                ...
                "controller-inline-validation": RuleConfig(enabled=True, severity="medium", category="validation", thresholds={"high_if_rules_ge": 6}),
                ...
                "inertia-page-missing-head": RuleConfig(enabled=True, severity="medium", category="react_best_practice"),
