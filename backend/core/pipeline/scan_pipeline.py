...
class ScanPipeline:
    ...
    def __init__(
        ...
        *,
        ...
        contract_stage: ContractChecksStage | None = None,
        ...
        self.contract_stage = contract_stage or ContractChecksStage()
    ...
    async def run(self) -> ScanReport:
        ...
        await self._run_stage("contract_checks", self.contract_stage.run, critical=False)
